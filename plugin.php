 ...
 * @since 1.0.0
 */
function tribe_extension_relabeler() {
	...
	tribe_register_provider( '\Tribe\Extensions\Relabeler\Plugin' );
}

// Loads after common is already properly loaded.
add_action( 'tribe_common_loaded', 'tribe_extension_relabeler' );
