...
$new_view = [
	'list'    => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_list_view' ),
	'month'   => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_month_view' ),
	'day'     => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_day_view' ),
	'week'    => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_week_view' ),
	'map'     => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_map_view' ),
	'photo'   => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_photo_view' ),
	'summary' => tribe('settings.manager')->get_option( 'tec_labs_relabeler_label_summary_view' ),
];

if ( array_key_exists( $public_view_slug, $new_view ) ) {
	$view_slug_dropdown = $new_view[ $public_view_slug ];
} else {
	$view_slug_dropdown = $public_view_data->view_label;
}
?>
<li class="<?php echo esc_attr( implode( ' ', $list_item_classes ) ); ?>">
	...
	>
		...
		<span class="tribe-events-c-view-selector__list-item-text">
			...
			<?php echo esc_html( $view_slug_dropdown ); ?>
		</span>
	</a>
</li>
